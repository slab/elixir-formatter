...
# ElixirFormatterWeb.Endpoint.init/2 when load_from_system_env is
...
# Google Analytics
config :elixir_formatter, :ga, id: "UA-84928209-3"
...
# start per endpoint:
#
#     config :elixir_formatter, ElixirFormatterWeb.Endpoint, server: true
#
